...
* Web UI - Single-page Angular web application providing the front-end that runs in the user's browser.
...
&#8224; Features yet to be ported to V2 of Stratos. For more details see [V1](https://github.com/SUSE/stratos-ui)
