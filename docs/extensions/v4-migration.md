...
Modules and routes are now exposed in a more standard package way. More info [here](./frontend.md#including-modules-and-routes).
...
- Material Design theming approach has been expanded to include many common colors, this removes the need to apply custom styles in a lot of cases. More info [here](../theming-architecture.md).
- Dark theme is applied in a different way. More info [here](../theming-architecture.md).
- Image assets are replaced in a different way. More info [here](../theming-architecture.md).
- Custom component can now be themed, so theme colors can be accessed from within and applied. More info [here](../theming-architecture.md).
- A new 'loading' indicator has been added that you may wish to customize, more info [here](./frontend.md#loading-indicator).
