...
> For those with existing customization migrating to 4.0 please see our [upgrade guide](./v4-migration.md).
...
Information on additional functionality can be found in the [extensions page](./frontend.md).
...
More information can be found in the [custom plugins page](./backend.md).
   ...
   2. Adding the following content to `stratos.yaml`
      ...
      packages:
        include:
          ...
          - '@example/theme'
      ```
1. Run Stratos the usual way, for more information see the [Developer Guide](../developer/introduction.md).
...
To run Stratos with these customizations simply start the console the usual way from that repo, for more information see the [Developer Guide](../developer/introduction.md).

## Further Reading

Detailed instructions on how to customize the [theme](../theming-architecture.md), [frontend functionality](./frontend.md) and [backend](./backend.md) can be found in this section.
