(function () {
  ...
  /**
   * @name code-engine.view.application.delivery-logs.ceTriggerBuildDetailView
  ...
  angular
    ...
    .factory('ceTriggerBuildDetailView', ceTriggerBuildDetailView);

  function ceTriggerBuildDetailView(frameworkDetailView) {
    return {
      /**
       * @function open
      ...
      open: function (project, cnsiGuid) {
        return frameworkDetailView({
          templateUrl: 'plugins/code-engine/view/application/delivery-logs/trigger-build/trigger-build.html',
