(function () {
  ...
  describe('trigger build service', function () {
    var promise, dialogContext, $controller, $q, modelManager, ceManageVcsTokens, hceModel, $httpBackend, $uibModalInstance, $timeout;
    ...
    beforeEach(inject(function ($injector, $rootScope, _$httpBackend_, _$q_, _$timeout_) {
      ...
      var triggerBuild = $injector.get('ceTriggerBuildDetailView');
    ...
    describe('Factory', function () {
      ...
      describe('open', function () {
        it('Plumbing / Initial state', function () {
          ...
          new $controller($timeout, $uibModalInstance, $q, ceManageVcsTokens, dialogContext, undefined, modelManager);
    ...
    describe('Controller', function () {
      ...
      beforeEach(function () {
        // $timeout, $uibModalInstance, $q, ceManageVcsTokens, context, content, modelManager
        controller = new $controller($timeout, $uibModalInstance, $q, ceManageVcsTokens, dialogContext, undefined, modelManager);
