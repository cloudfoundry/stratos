(function () {
  ...
  describe('Add-notification-target', function () {
    ...
    beforeEach(inject(function ($injector) {
      ...
      addNotificationTargetService = $injector.get('ceAddNotificationService');
      var $controller = $injector.get('$controller');
      addNotificationTargetController = $controller('code-engine.view.application.delivery-pipeline.addNotificationTargetController', {
