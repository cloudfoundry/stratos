(function () {
  ...
  function OrganizationSummaryTile() {
    return {
      ...
      scope: {},
      templateUrl: 'plugins/cloud-foundry/view/dashboard/cluster/organization/detail/summary-tile/organization-summary-tile.html'
    };
  }
  ...
  function OrganizationSummaryTileController($scope, $state, $stateParams, $q, $translate, modelManager, appUtilsService,
    ...
    this.cardData = {
      titleTranslate: 'cf.org-info.summary.title'
    };
    ...
    var deleteAction = {
      ...
      execute: function () {
        frameworkDialogConfirm({
          ...
          description: $translate.instant('cf.org-info.delete-dialog.description', { name: that.organization.details.org.entity.name}),
          submitCommit: true,
          buttonText: {
            yes: 'buttons.delete',
            no: 'buttons.cancel'
          ...
          callback: function () {
            ...
            return that.cfOrganizationModel.deleteOrganization(that.clusterGuid, that.organizationGuid)
              .then(function () {
                appNotificationsService.notify('success',
                  $translate.instant('cf.org-info.delete-dialog.success-notification', {name: name}));
