(function () {
  ...
  function registerAppTab($stateParams, cfApplicationTabs) {
    cfApplicationTabs.tabs.push({
      position: 10,
      hide: false,
      uiSref: 'cf.applications.application.service-catalogue',
      uiSrefParam: function () {
        return {guid: $stateParams.guid};
      },
      label: 'app.app-info.app-tabs.service-catalogue.label'
    });
  }

  /**
   * @name ApplicationServiceCatalogueController
   * @constructor
   ...
   */
  function ApplicationServiceCatalogueController($scope, modelManager, $stateParams) {
    var that = this;
