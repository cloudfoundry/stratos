...
import { getKubeAppId, kubernetesAppsEntityType, kubernetesEntityFactory } from '../../kubernetes-entity-factory';
...
export class KubernetesAppsDataSource extends ListDataSource<KubernetesApp> {
  ...
  constructor(
    ...
    super({
      ...
      paginationKey: getPaginationKey(kubernetesAppsEntityType, kubeGuid.guid),
      isLocal: true,
      listConfig,
