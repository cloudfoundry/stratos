...
- Sized the console at `512M`. Both packaged manifests claimed `256M`, a figure
  dating from 2017 that was never checked against a running console; cloud.gov
  runs Stratos in production at `512M`, and the Korifi manifest generated by the
