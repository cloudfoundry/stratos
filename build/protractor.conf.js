...
(function () {
  ...
  if (secrets.headless) {
    exports.config.capabilities.chromeOptions.args = [ '--headless', '--remote-debugging-port=9222', '--ignore-certificate-errors', '--disable-gpu', '--window-size=1280,800', '--no-sandbox' ];
  }
