(function () {
  ...
  function RolesTables() {
    return {
      ...
      scope: {},
      templateUrl: 'plugins/cloud-foundry/view/dashboard/cluster/actions/roles-tables/roles-tables.html'
    };
  }
   ...
   * @param {cloud-foundry.view.dashboard.cluster.appClusterRolesService} appClusterRolesService - the console roles service. Aids in
