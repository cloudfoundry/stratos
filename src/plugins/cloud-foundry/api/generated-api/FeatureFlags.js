...
(function () {
  ...
  angular.extend(FeatureFlagsApi.prototype, {
    ...
    * For detailed information, see online documentation at: http://apidocs.cloudfoundry.org/231/feature_flags/get_all_feature_flags.html
    */
    ...
    * For detailed information, see online documentation at: http://apidocs.cloudfoundry.org/231/feature_flags/get_the_app_bits_upload_feature_flag.html
    */
    ...
    * For detailed information, see online documentation at: http://apidocs.cloudfoundry.org/231/feature_flags/get_the_app_scaling_feature_flag.html
    */
    ...
    * For detailed information, see online documentation at: http://apidocs.cloudfoundry.org/231/feature_flags/get_the_diego_docker_feature_flag.html
    */
    ...
    * For detailed information, see online documentation at: http://apidocs.cloudfoundry.org/231/feature_flags/get_the_private_domain_creation_feature_flag.html
    */
    ...
    * For detailed information, see online documentation at: http://apidocs.cloudfoundry.org/231/feature_flags/get_the_route_creation_feature_flag.html
    */
    ...
    * For detailed information, see online documentation at: http://apidocs.cloudfoundry.org/231/feature_flags/get_the_service_instance_creation_feature_flag.html
    */
    ...
    * authority
    * For detailed information, see online documentation at: http://apidocs.cloudfoundry.org/231/feature_flags/get_the_set_user_roles_feature_flag.html
    */
    ...
    * For detailed information, see online documentation at: http://apidocs.cloudfoundry.org/231/feature_flags/get_the_space_scoped_private_broker_creation_feature_flag_(experimental).html
    */
    ...
    * .
    * For detailed information, see online documentation at: http://apidocs.cloudfoundry.org/231/feature_flags/get_the_task_creation_feature_flag_(experimental).html
    */
    ...
    * 2) Create a UAA `cloud_controller_username_lookup` client with the `scim.userids`
    * authority
    * For detailed information, see online documentation at: http://apidocs.cloudfoundry.org/231/feature_flags/get_the_unset_user_roles_feature_flag.html
    */
    ...
    * For detailed information, see online documentation at: http://apidocs.cloudfoundry.org/231/feature_flags/get_the_user_org_creation_feature_flag.html
    */
   ...
   /*
    * Set a feature flag
    * For detailed information, see online documentation at: http://apidocs.cloudfoundry.org/231/feature_flags/set_a_feature_flag.html
    */
