(function (mock) {
  ...
  mock.cloudFoundryAPI.Users = {
    ...
    ListAllSpacesForUser: function (userGuid, spaceGuid, orgGuid) {

      spaceGuid = spaceGuid || 'spaceGuid';
      orgGuid = orgGuid || 'orgGuid';

      return {
        url: '/pp/v1/proxy/v2/users/' + userGuid + '/spaces?results-per-page=100',
    ...
    GetUserSummary: function (guid, spaceGuid) {

      var mySpaceGuid = spaceGuid || 'spaceGuid';
      var clusterGuid = guid || 'cnsiGuid';
      return {
        url: '/pp/v1/proxy/v2/users/' + clusterGuid + '/summary',
              ...
              organizations: [{
                ...
                entity: {
                  ...
                  spaces: [{
                    metadata: {
                      guid: mySpaceGuid,
                      created_at: "2016-08-100% 25T12:02:20Z",
                      updated_at: null
                    }, entity: {name: "mySpace"}
                  }, {
                    metadata: {
