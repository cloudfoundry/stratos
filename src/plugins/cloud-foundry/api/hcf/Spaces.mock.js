(function (mock) {
  ...
  mock.cloudFoundryAPI.Spaces = {
      ...
      return {
        ...
        response: {
          ...
          200: {
            ...
            body: {
              "guid": ListAllAppsForSpace[200].body
            }
          },

          500: {
            body: {guid: ListAllAppsForSpace[500].body}
          }
        }
      };
    },

    ListAllAppsForSpaceNoPassthrough: function (guid) {
      return {
        url: '/pp/v1/proxy/v2/spaces/' + guid + '/apps?results-per-page=100',

        response: ListAllAppsForSpace
      };
    },
    ...
    RetrievingRolesOfAllUsersInSpace: function (guid) {
      return {
        url: '/pp/v1/proxy/v2/spaces/' + guid + '/user_roles?results-per-page=100',
        response: {
          200: {
            body: {
              "total_results": 3,
              ...
              "resources": [
                {
                  "metadata": {
                    ...
                    "created_at": "2016-10-11T17:00:51Z",
                    "updated_at": null
                  },
                  "entity": {
                    "admin": false,
                ...
                {
                  "metadata": {
                    "guid": "280391c9-335d-4f03-83d9-af64fc315b6c",
                    "url": "/v2/users/280391c9-335d-4f03-83d9-af64fc315b6c",
                    "created_at": "2016-10-11T17:57:39Z",
                    "updated_at": null
                  },
                  "entity": {
                    "admin": false,
                    ...
                    "default_space_guid": null,
                    "username": "admin",
                    "spaces_url": "/v2/users/280391c9-335d-4f03-83d9-af64fc315b6c/spaces",
                    "organizations_url": "/v2/users/280391c9-335d-4f03-83d9-af64fc315b6c/organizations",
                    "managed_organizations_url": "/v2/users/280391c9-335d-4f03-83d9-af64fc315b6c/managed_organizations",
                    "billing_managed_organizations_url": "/v2/users/280391c9-335d-4f03-83d9-af64fc315b6c/billing_managed_organizations",
                    "audited_organizations_url": "/v2/users/280391c9-335d-4f03-83d9-af64fc315b6c/audited_organizations",
                    "managed_spaces_url": "/v2/users/280391c9-335d-4f03-83d9-af64fc315b6c/managed_spaces",
                    "audited_spaces_url": "/v2/users/280391c9-335d-4f03-83d9-af64fc315b6c/audited_spaces"
                  }
                },
                {
                  "metadata": {
                    "guid": "0683b8d1-767d-4063-9ae6-bc2194d7f3da",
                    "url": "/v2/users/0683b8d1-767d-4063-9ae6-bc2194d7f3da",
                    "created_at": "2016-10-12T19:07:32Z",
                    "updated_at": null
                  },
                  "entity": {
                    "admin": false,
                    ...
                    "default_space_guid": null,
                    "username": "rcox",
                    "spaces_url": "/v2/users/0683b8d1-767d-4063-9ae6-bc2194d7f3da/spaces",
                    "organizations_url": "/v2/users/0683b8d1-767d-4063-9ae6-bc2194d7f3da/organizations",
                    "managed_organizations_url": "/v2/users/0683b8d1-767d-4063-9ae6-bc2194d7f3da/managed_organizations",
                    "billing_managed_organizations_url": "/v2/users/0683b8d1-767d-4063-9ae6-bc2194d7f3da/billing_managed_organizations",
                    "audited_organizations_url": "/v2/users/0683b8d1-767d-4063-9ae6-bc2194d7f3da/audited_organizations",
                    "managed_spaces_url": "/v2/users/0683b8d1-767d-4063-9ae6-bc2194d7f3da/managed_spaces",
                    "audited_spaces_url": "/v2/users/0683b8d1-767d-4063-9ae6-bc2194d7f3da/audited_spaces"
                  }
                }
              ]
            }
