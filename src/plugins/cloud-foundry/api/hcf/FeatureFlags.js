...
(function () {
  ...
  angular.extend(FeatureFlagsApi.prototype, {
    ...
    * For detailed information, see online documentation at: http://apidocs.cloudfoundry.org/195/feature_flags/get_the_space_developer_environment_variable_visibility_feature_flag_(experimental).html
    */
    GetSpaceDeveloperEnvironmentVariableVisibilityFeatureFlagExperimental: function (params, httpConfigOptions) {
      var config = {};
      config.params = params;
      config.url = '/api/cf/v2/config/feature_flags/space_developer_env_var_visibility';
      config.method = 'GET';
