(function () {
   ...
   * @param {object} ceAddNotificationService - Service for adding new notifications
   * @param {object} cePostDeployActionService - Service for adding a new post-deploy action
  ...
  angular.extend(ApplicationDeliveryPipelineController.prototype, {
    ...
    addNotificationTarget: function () {
      var that = this;
      this.ceAddNotificationService.add(this.hceCnsi && this.hceCnsi.guid)
        .result
    ...
    addPostDeployAction: function () {
      var that = this;
      this.cePostDeployActionService.add(this.hceCnsi.guid, this.project.id)
        .result
