(function () {
   ...
   * @param {helion.framework.widgets.dialog.confirm} frameworkWidgetsDialogConfirm The framework confirmation dialog
   ...
   */
  function ManageVcsTokensService($q, $timeout, PAT_DELIMITER, modelManager, asyncTaskDialog, frameworkWidgetsDialogConfirm, notificationsService, registerVcsToken, editVcsToken) {
