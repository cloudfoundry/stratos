...
// import { CfFeatureFlagsDataSource, FeatureFlagDescriptions } from './cf-cells-data-source';
// import { TableCellFeatureFlagStateComponent } from './table-cell-feature-flag-state/table-cell-feature-flag-state.component';

// @Injectable()
// export class CfCellsListConfigService extends BaseCfListConfig<APIResource<IFeatureFlag>> {
