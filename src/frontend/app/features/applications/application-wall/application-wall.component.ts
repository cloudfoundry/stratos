...
import { CfAppConfigService } from '../../../shared/components/list/list-configs/cf-app-config.service';
import { CardAppComponent } from '../../../shared/components/list/cards/custom-cards/card-app/card-app.component';
