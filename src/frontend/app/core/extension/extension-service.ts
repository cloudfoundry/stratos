...
import { addEndpointAuthTypes } from '../../features/endpoints/endpoint-helpers';
...
export function StratosExtension(config: StratosExtensionConfig) {
  return function (_target) {
    ...
    extensionMetadata.authTypes = extensionMetadata.authTypes.concat(config.authTypes || []);
  };
}
...
export class ExtensionService {
  ...
  public init() {
    applyRoutesFromExtensions(this.router);
