...
console.log('[TEST SETUP - AUTOSCALER] Checking TestBed platform...');
const testBed = getTestBed();
if (!testBed.platform) {
  console.log('[TEST SETUP - AUTOSCALER] Initializing TestBed platform...');
  ...
  console.log('[TEST SETUP - AUTOSCALER] ✅ TestBed platform initialized');
} else {
  console.log('[TEST SETUP - AUTOSCALER] TestBed platform already initialized (shared)');
}
