...
export class CloudFoundryTabsBaseComponent implements OnInit {
  ...
  constructor(
    ...
    // const cellsHidden$ = endpointsService.hasCellMetrics(cfEndpointService.cfGuid).pipe(
    ...
    // We can change this to not show at first... which would then move the flicker on to the deigo cell's use case
