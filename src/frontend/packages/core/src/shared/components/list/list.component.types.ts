...
// Page-size sentinels/helpers were lifted to
// `../signal-list/page-size.types.ts` (workstream D-R-A) so they survive
// deletion of this legacy file.
...
export class MultiFilterManager<T> {
  ...
  public value$ = new BehaviorSubject<string | undefined>(undefined);
