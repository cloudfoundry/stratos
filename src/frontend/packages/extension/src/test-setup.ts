...
console.log('[TEST SETUP - EXTENSION] Checking TestBed platform...');
const testBed = getTestBed();
if (!testBed.platform) {
  console.log('[TEST SETUP - EXTENSION] Initializing TestBed platform...');
  ...
  console.log('[TEST SETUP - EXTENSION] ✅ TestBed platform initialized');
} else {
  console.log('[TEST SETUP - EXTENSION] TestBed platform already initialized (shared)');
}
