...
import { entityCatalog, type TestEntityCatalog } from './entity-catalog/entity-catalog';
...
// Note: This import is intentionally dynamic and may not resolve to a module
