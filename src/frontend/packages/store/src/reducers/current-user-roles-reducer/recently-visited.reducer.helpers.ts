import type { EntityDeleteCompleteAction } from '../../actions/entity.delete.actions';
import type { AddRecentlyVisitedEntityAction } from '../../actions/recently-visited.actions';
import type { IRecentlyVisitedEntity, IRecentlyVisitedState } from '../../types/recently-visited.types';
