...
console.log('[TEST SETUP - CF] Checking TestBed platform...');
const testBed = getTestBed();
if (!testBed.platform) {
  console.log('[TEST SETUP - CF] Initializing TestBed platform...');
  ...
  console.log('[TEST SETUP - CF] ✅ TestBed platform initialized');
} else {
  console.log('[TEST SETUP - CF] TestBed platform already initialized (shared)');
}
