...
import { RecentlyVisitedDataService, UserFavorite, UserFavoritesDataService } from '@stratosui/store';
...
describe('FavoritesRecentsDeleteCleanup', () => {
  ...
  it('removes the favorite (signal-native) for the deleted entity', () => {
