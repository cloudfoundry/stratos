...
console.log('[TEST SETUP - SHARED] Checking TestBed platform...');
const testBed = getTestBed();
if (!testBed.platform) {
  console.log('[TEST SETUP - SHARED] Initializing TestBed platform...');
  ...
  console.log('[TEST SETUP - SHARED] ✅ TestBed platform initialized');
} else {
  console.log('[TEST SETUP - SHARED] TestBed platform already initialized (shared)');
}
