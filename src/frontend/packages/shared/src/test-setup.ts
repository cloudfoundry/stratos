...
// Note: setup-snapshots is loaded as a side-effect module via import
// @ts-expect-error - setup-snapshots.d.ts is not a proper module, but the import works at runtime
void import('@analogjs/vitest-angular/setup-snapshots').catch(() => {
