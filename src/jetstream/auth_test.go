...
func TestVerifySession(t *testing.T) {
	...
	Convey("Test verify session", t, func() {
		...
		var expectedBody = "{\"version\":{\"proxy_version\":\"dev\",\"database_version\":20161117141922},\"user\":{\"guid\":\"asd-gjfg-bob\",\"name\":\"admin\",\"admin\":false," + expectedScopes + "},\"endpoints\":{\"cf\":{}},\"plugins\":null,\"config\":{\"enableTechPreview\":false,\"listAllowLoadMaxed\":false}}"
