...
//
//	mockgen -source=repository/apikeys/apikeys.go -destination=repository/apikeys/mock/mock_apikeys.go -package=mock_apikeys
//
...
func (mr *MockRepositoryMockRecorder) AddAPIKey(userID, comment any) *gomock.Call {
...
func (mr *MockRepositoryMockRecorder) DeleteAPIKey(userGUID, keyGUID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRepositoryMockRecorder) GetAPIKeyBySecret(keySecret any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRepositoryMockRecorder) ListAPIKeys(userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRepositoryMockRecorder) UpdateAPIKeyLastUsed(keyGUID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
