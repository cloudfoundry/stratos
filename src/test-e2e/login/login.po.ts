...
export class LoginPage {
  ...
  getLoginError() {
    return element(by.css('.suse-login__message.suse-login__message--show.suse-login__message-error')).getText();
  }
  ...
  waitForLogin() {
    return browser.wait(until.presenceOf(element(by.tagName('app-suse-login'))), 10000);
  }
