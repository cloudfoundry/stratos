...
ORGQUOTA_NAME=susecon-org-quota
...
SPACEQUOTA_NAME=susecon-space-quota
...
SERVICE_NAME="susecon-persi-nfs"

SERVICEINSTANCE_PCF_1_TYPE=p-mysql
SERVICEINSTANCE_PCF_1_PLAN=512mb
SERVICEINSTANCE_PCF_1_NAME=susecon-p-mysql
...
SERVICEINSTANCE_PCF_2_NAME=susecon-p-rabbitmq
...
SERVICEINSTANCE_SCF_1_NAME=susecon-mysql-dev-1
...
SERVICEINSTANCE_SCF_2_NAME=susecon-mysql-dev-2
